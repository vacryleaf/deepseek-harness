...
export const TRANSLATION_SCOPE_GLOB_EXCLUDES = [
  ...
  'apps/web/dist/**',
  '.artifacts/**',
  'plugin/python-sdk/sdk-runtime/src/deepseek_harness_runtime/runtime/dsh-jsonrpc-agent-*/**',
  'plugin/python-sdk/sdk-runtime/src/deepseek_harness_runtime/runtime/node/**',
  'vendor/**',
]
...
function isTranslationSourceExcluded(file: string): boolean {
  ...
  return segments.some(segment => NON_SOURCE_DIRECTORIES.has(segment)
    ...
    || file.startsWith('plugin/python-sdk/sdk-runtime/src/deepseek_harness_runtime/runtime/dsh-jsonrpc-agent-')
    || file.startsWith('plugin/python-sdk/sdk-runtime/src/deepseek_harness_runtime/runtime/node/')
}
...
export function isTranslationScopeFile(file: string): boolean {
  return !file.startsWith('.agents/notes/archived/')
    ...
    || file.startsWith('plugin/python-sdk/'))
}
